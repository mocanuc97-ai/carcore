...
export default function VehicleEditForm({
  ...
  return (
    <form action={handleSubmit} className="grid grid-cols-2 gap-3">
      ...
      <input name="color" defaultValue={color} placeholder="Culoare" className="border rounded-xl px-4 py-2 col-span-2" />
      <SubmitButton pendingText="Se salvează..." className="bg-black text-white rounded-xl px-4 py-2 col-span-2 disabled:opacity-50">
        Salvează
      </SubmitButton>
    </form>
  );
